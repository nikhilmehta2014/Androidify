 ...
 */
class RefreshMainDataWork(context: Context, params: WorkerParameters, private val network: BasicCoroutinesNetwork) :
    ...
    class Factory(val network: BasicCoroutinesNetwork = getNetworkService()) : WorkerFactory() {
